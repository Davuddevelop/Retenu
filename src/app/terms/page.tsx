                ...
                <div className="prose prose-invert max-w-none">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 leading-relaxed">
                                        By accessing or using RevenueLeak, you agree to be bound by these Terms of Service.
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-400 leading-relaxed mb-4">
                            RevenueLeak provides automated revenue leak detection and financial analytics for agencies and service businesses.
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-400 mb-4">To use RevenueLeak, you must:</p>
                    ...
                    <section>
                        ...
                        <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                            <p className="text-gray-400 mb-2">
                                <strong className="text-[var(--foreground)]">Email:</strong> legal@revenueleak.com
                            </p>
                            <p className="text-gray-400">
                                <strong className="text-[var(--foreground)]">Support:</strong> support@revenueleak.com
                            </p>
                        </div>
                    </section>
                </div>
