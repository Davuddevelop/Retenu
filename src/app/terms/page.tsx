                ...
                <div className="prose prose-invert max-w-none">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400 leading-relaxed">
                                        By accessing or using RETENU, you agree to be bound by these Terms of Service.
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-400 leading-relaxed mb-4">
                            RETENU provides automated revenue leak detection and financial analytics for agencies and service businesses.
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-400 mb-4">To use RETENU, you must:</p>
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-400 mb-4">
                            RETENU is provided &quot;as is&quot; without warranties of any kind. To the maximum extent permitted by law:
                        </p>
                        <ul className="list-disc list-inside text-gray-400 space-y-2">
