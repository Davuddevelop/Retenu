...
const leakScenarios = [
  {
    ...
    detection: 'RevenueLeak compares time tracking data (Toggl/Clockify) with invoiced hours and flags discrepancies in real-time.',
    impact: '$7,050',
  ...
  },
  {
    ...
    detection: 'RevenueLeak tracks project status updates and automatically flags completed milestones without corresponding invoices.',
    impact: '$12,500',
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            <span className="text-[var(--leak)] font-semibold">42% of businesses</span> actively face revenue leakage.
            Click through real scenarios from agencies like yours—each represents actual loss that RevenueLeak prevents.
          </motion.p>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="font-semibold text-[var(--foreground)]">How RevenueLeak Detects It</h4>
                    </div>
                    <p className="text-gray-300 leading-relaxed pl-7">
