...
const stats = [
  { value: '$47K', label: 'Average Annual Recovery', icon: TrendingUp },
  { value: '99.9%', label: 'Detection Accuracy', icon: Shield },
  { value: '<2min', label: 'Alert Response Time', icon: Bell },
  { value: '500+', label: 'Agencies Protected', icon: FileSearch },
];
